...
LOCATOR_EDITABLE = "xpath=(//*[contains(text(),'项目')]/following-sibling::*[self::div or self::span]//input[not(ancestor::*[contains(@class,'is-hidden')]) and not(ancestor::*[contains(@style,'display: none')])][@class='el-input__inner'])[1][not(@readonly)]"
