#!/usr/bin/env python3
"""
验证假设：先访问 authority-manage 初始化上下文，再访问 role
"""
...
with sync_playwright() as p:
    ...
    # Step 1: 导航到 root + 设置 localStorage
    print("=== Step 1: Navigate to root + set localStorage ===")
    ...
    # Step 2: 先访问 authority-manage（初始化上下文）
    print("\n=== Step 2: Visit authority-manage first (init context) ===")
    page.goto('http://10.151.37.249/estack/web/estack/user-center/user-manage/authority-manage',
    ...
    # 检查 localStorage
    print("\n=== Step 3: Check localStorage after authority-manage ===")
    ls = page.evaluate("() => Object.keys(localStorage)")
    print(f"  localStorage keys: {ls}")

    # Step 4: 现在访问 role
    print("\n=== Step 4: Now visit role ===")
