...
for key in sorted(KB_TYPE_KEYS):
    ...
    from core.element_types import _ASSERTION_TYPES
...
from core.field_suffixes import SUFFIX_MAP, _STEP_TYPE_ALIASES
...
from generation import case_generator as _cg_mod
...
from core.element_types import FIELD_TYPE_SUFFIXES as TYPE_SUFFIXES
...
from core.element_types import infer_type_from_field as _infer_type
