...
def run():
    ...
    url = 'http://console-estack-intel.cmecloud.cn/estack/web/ecm-compute-static/vm/list?productType=vm'
    ...
    with sync_playwright() as pw:
        ...
        for part in cookie_parts:
            ...
            if '=' in part:
                ...
                cookies.append({
                    'name': name.strip(),
                    'value': value.strip(),
                    'domain': 'console-estack-intel.cmecloud.cn',
                    'path': '/'
                })
        ...
        # Take screenshot
        page.screenshot(path='tests/debug_page_state.png', full_page=True)
        print("\nScreenshot saved to tests/debug_page_state.png")
