...
LOCATOR_OPTION = "xpath=(//div[@x-placement and not(@x-placement='')]//li[contains(.,'Project-060f0629') and not(ancestor-or-self::*[contains(@class,'is-hidden')]) and not(ancestor-or-self::*[contains(@style,'display: none')])])[1]"
...
def main():
    ...
    with sync_playwright() as p:
        ...
        print("   document.evaluate(\"(//div[@x-placement and not(@x-placement='')]//li[contains(.,'Project-060f0629')])[1]\", document, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null).singleNodeValue")
